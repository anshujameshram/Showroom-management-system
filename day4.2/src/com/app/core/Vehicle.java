...
public class Vehicle {
	...
	//covariance is not applicable to primitive type
	@Override
	public boolean equals(Object o) {   //equals method come from object class 
		System.out.println("in vehicle equals");
		if (o instanceof Vehicle)
			return this.chasisNo.equals(((Vehicle) o).chasisNo);   //String equals is calling 
		return false;
	}
}
