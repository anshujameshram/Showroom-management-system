...
public class VehicleValidationRules {
	...
	public static Vehicle validateAllInputs(String chasisNo, String vehicleColor, double basePrice,
		...
		// => all valid i/ps --wrap these details in Vehicle class instance n return the
	...
	public static LocalDate parseAndValidateDate(String date) throws VehicleHandlingException {
		// parsing
		LocalDate d1 = LocalDate.parse(date); // string to date
		// parsing successful ---proceed to validation : current year
		// create LocalDate instance : beginning of the year
